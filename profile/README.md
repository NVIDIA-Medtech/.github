...
[![Isaac for Healthcare](https://img.shields.io/badge/Isaac_for_Healthcare-76b900?logo=nvidia&logoColor=white)](https://developer.nvidia.com/isaac/healthcare)
...
NVIDIA **Isaac for Healthcare** is the three-computer solution for healthcare robotics: a domain-specific framework on [Isaac Sim](https://developer.nvidia.com/isaac/sim), [Isaac Lab](https://developer.nvidia.com/isaac/lab), [Omniverse](https://developer.nvidia.com/omniverse), and [Holoscan](https://developer.nvidia.com/holoscan-sdk) for simulating, training, and deploying AI-enabled medical robots across surgical robotics, diagnostic imaging (ultrasound, CT, CBCT), and hospital and patient care.

**[Explore Isaac for Healthcare →](https://github.com/isaac-for-healthcare)**
...
- **Cosmos-H-Surgical**: Surgical video world model with Predict (future-state generation) and Transfer (control-conditioned generation)
